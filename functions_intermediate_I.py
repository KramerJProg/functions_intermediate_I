...
# 2 Create a function iterateDictionary(some_list) that, given 
# a list of dictionaries, the function loops through each dictionary 
...
def iterateDictionary(students):
    for student in students:
        print(", ".join(f"{key} - {val}" for key,val in student.items()))
iterateDictionary(students)


# 3. Create a function iterateDictionary2(key_name, some_list) that, 
